        ...
        <CardHeader className="space-y-1 text-center">
          ...
          >
            ...
            <CardDescription className="text-gray-400">
              Sign in to your CalcFlow account
            </CardDescription>
          </motion.div>
        </CardHeader>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                {...register("email")}
                className="border-white/10 bg-white/5 text-white placeholder:text-gray-500 focus-visible:ring-blue-500"
              />
              {errors.email && (
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                type="checkbox"
                {...register("rememberMe")}
                className="h-4 w-4 rounded border-gray-600 bg-white/5 text-blue-600 focus:ring-blue-500"
              />
